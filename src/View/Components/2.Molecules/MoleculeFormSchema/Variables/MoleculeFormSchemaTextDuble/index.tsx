...
export type TComponent = {
	...
	btn: Omit<IBtn, "type">;
	submit?: (val: TSchemaTextDuble) => void;
};

export type TSchemaTextDuble = { title: string; subtitle: string };

export default Component.Create(Model, Style, View, "MoleculeFormSchemaTextDuble");
